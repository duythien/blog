...
<div class="well" align="center">
	...
	<table class="perms">
		<tr>
			...
			<td><?php echo Phalcon\Tag::select(array('profileId', $profiles, 'using' => array('id', 'name'), 'useEmpty' => true, 'emptyText' => '...', 'emptyValue' => '')); ?></td>
			<td><?php echo Phalcon\Tag::submitButton(array('Search', 'class' => 'btn btn-primary')); ?></td>
		</tr>
	</table>
