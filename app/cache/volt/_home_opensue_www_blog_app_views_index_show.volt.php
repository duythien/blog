...
<div class="row">
  ...
  <div class="span10">
        ...
        <li class="previous"><?php echo Phalcon\Tag::linkTo(array('view/' . $back . '/back', '&larr; Back')); ?> </li>
        <li class="next"><?php echo Phalcon\Tag::linkTo(array('view/' . $next . '/next', 'Newer &rarr;')); ?> 
        </li>
