  ...
  <div class="span8">
      <div class="content">
        <?php foreach ($page->items as $post) { ?>
          <h2><?php echo $this->tag->linkTo(array('view/' . $post->id . '/' . $post->slug, $this->escaper->escapeHtml($post->title))); ?></h2>
...
<div class="span9"></div>
 <div class="span3">   <ul class="pager">
  <li><?php echo $this->tag->linkTo(array('index?page=' . $page->before, '&larr; Older')); ?>
  </li>
  <li><?php echo $this->tag->linkTo(array('index?page=' . $page->next, 'Newer &rarr;')); ?></li>
</ul></div>
</div>